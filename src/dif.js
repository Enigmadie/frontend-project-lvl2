...
const propertyActions = [
  ...
  },
  {
    ...
    children: (func, first, second, el) => isObject(second[el], first[el]) ? func(first[el], second[el]) : [],
...
const getPropertyActions = (arg1, arg2, value) => propertyActions.find(({ check }) => check(arg1, arg2, value));
